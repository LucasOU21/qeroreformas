  ...
  "node_modules/@preline/accordion/index.js"(exports, module) {
    !function(t, e) {
      ...
      var t = { 740: function(t2, e2, n2) {
        ...
        var s = n2(292), c = function(t3) {
          function e3(e4, n3, o2) {
            var i2 = t3.call(this, e4, n3, o2) || this;
            return i2.toggle = i2.el.querySelector(".hs-accordion-toggle") || null, i2.content = i2.el.querySelector(".hs-accordion-content") || null, i2.update(), i2.isToggleStopPropagated = (0, s.stringToBoolean)((0, s.getClassProperty)(i2.toggle, "--stop-propagation", "false") || "false"), i2.toggle && i2.content && i2.init(), i2;
          }
          return i(e3, t3), e3.prototype.init = function() {
            ...
            this.el.classList.add("active"), (null === (t4 = null == this ? void 0 : this.toggle) || void 0 === t4 ? void 0 : t4.ariaExpanded) && (this.toggle.ariaExpanded = "true"), this.content.style.display = "block", this.content.style.height = "0", setTimeout(function() {
              e4.content.style.height = "".concat(e4.content.scrollHeight, "px"), (0, s.afterTransition)(e4.content, function() {
            ...
            this.selectable = [], document.querySelectorAll(".hs-accordion-treeview-root").forEach(function(e4) {
              ...
              t4.selectable.push({ el: e4, options: r({}, o2), listeners: [] });
              ...
              e4.el.querySelectorAll(".hs-accordion-selectable").forEach(function(n3) {
                var o2 = function(o3) {
                  return t4.onSelectableClick(o3, e4, n3);
                };
                n3.addEventListener("click", o2), e4.listeners.push({ el: n3, listener: o2 });
              });
            });
          ...
          }, e3.onSelectableClick = function(t4, n3, o2) {
            t4.stopPropagation(), e3.toggleSelected(n3, o2);
          }, e3;
        }(l(n2(961)).default);
        window.addEventListener("load", function() {
          c.autoInit(), document.querySelectorAll(".hs-accordion-treeview-root").length && c.treeView();
        }), "undefined" != typeof window && (window.HSAccordion = c), e2.default = c;
      }, 961: (t2, e2) => {
        Object.defineProperty(e2, "__esModule", { value: true });
        var n2 = function() {
        ...
        e2.isDirectChild = function(t3, e3) {
          for (var n3 = t3.children, o2 = 0; o2 < n3.length; o2++) if (n3[o2] === e3) return true;
          return false;
        };
        e2.isEnoughSpace = function(t3, e3, n3, o2, i2) {
          void 0 === n3 && (n3 = "auto"), void 0 === o2 && (o2 = 10), void 0 === i2 && (i2 = null);
          var r = e3.getBoundingClientRect(), l = i2 ? i2.getBoundingClientRect() : null, s = window.innerHeight, c = l ? r.top - l.top : r.top, a = (i2 ? l.bottom : s) - r.bottom, u = t3.clientHeight + o2;
          return "bottom" === n3 ? a >= u : "top" === n3 ? c >= u : c >= u || a >= u;
        };
