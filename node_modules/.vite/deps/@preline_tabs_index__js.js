      ...
      var t = { 223: (t2, e2) => {
        ...
        var s = n2(292), a = i(n2(961)), l = n2(223), c = function(t3) {
          function e3(e4, n3, o2) {
            ...
            }), r2.currentContentId = r2.current.getAttribute("data-hs-tab"), r2.currentContent = document.querySelector(r2.currentContentId), r2.prev = null, r2.prevContentId = null, r2.prevContent = null, r2.eventType = "click", r2.onToggleClickListener = [], r2.init(), r2;
          }
          return r(e3, t3), e3.prototype.toggleClick = function(t4) {
            this.open(t4);
